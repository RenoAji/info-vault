        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-16 sm:pt-24 sm:pb-20">
          <div className="text-center">
            ...
            <p className="text-xl sm:text-2xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto mb-12 leading-relaxed">
              Upload documents, generate intelligent notes, and chat with AI to
              unlock insights from your knowledge base. Transform how you learn
              and work.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <Link
                className="bg-gradient-to-r from-blue-500 to-purple-600 text-white px-8 py-4 rounded-full text-lg font-semibold hover:from-blue-600 hover:to-purple-700 transition-all transform hover:scale-105 shadow-lg"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
              Everything you need to organize, understand, and leverage your
              information
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-900/20 dark:to-blue-800/20 p-8 rounded-2xl border border-blue-200 dark:border-blue-800">
              ...
              <p className="text-gray-600 dark:text-gray-300">
                Upload PDFs, documents, images, and more. Our AI automatically
                extracts and organizes key information from any file type.
              </p>
            </div>
            ...
            <div className="bg-gradient-to-br from-purple-50 to-purple-100 dark:from-purple-900/20 dark:to-purple-800/20 p-8 rounded-2xl border border-purple-200 dark:border-purple-800">
              ...
              <p className="text-gray-600 dark:text-gray-300">
                Automatically generate comprehensive notes, summaries, and key
                insights from your documents using advanced AI.
              </p>
            </div>
            ...
            <div className="bg-gradient-to-br from-green-50 to-green-100 dark:from-green-900/20 dark:to-green-800/20 p-8 rounded-2xl border border-green-200 dark:border-green-800">
              ...
              <p className="text-gray-600 dark:text-gray-300">
                Chat with your knowledge base. Ask questions, get insights, and
                discover connections across all your documents.
              </p>
            </div>
          </div>
        </div>
      ...
      <section id="how-it-works" className="py-20 bg-gray-50 dark:bg-black">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
              Three simple steps to transform your documents into actionable
              knowledge
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600 dark:text-gray-300">
                Drag and drop your files or browse to upload. Support for PDFs,
                Word docs, images, and more.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 dark:text-gray-300">
                Our AI analyzes your content, extracts key information, and
                generates intelligent notes and summaries.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 dark:text-gray-300">
                Ask questions, explore connections, and unlock insights from
