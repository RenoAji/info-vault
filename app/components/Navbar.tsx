            ...
            <div className="hidden md:flex items-center space-x-8">
              {isAuthenticated ? (
                <>
                  ...
                  <Link
                    href="/dashboard"
                    className="bg-gradient-to-r from-blue-500 to-purple-600 text-white px-6 py-2 rounded-full hover:from-blue-600 hover:to-purple-700 transition-all transform hover:scale-105"
                  >
                    Dashboard
                  </Link>
                </>
